...
if __name__ == '__main__':
    ...
    try:
        ...
        err_abort("no arguments given ! need path of lua file")
    if not os.path.exists(file_to_amalgame):
        err_abort('File not found - put the correct path with "/" as arg of the command')
    file_content = ''
    ...
    for file_name in file_names_to_amalgame:
        print('module is added : ' + file_name)
