...
class Robot:
    ...
    def __init__(self, interface: Interface, is_holonomic=True,  pos_init=(1500, 1000, 0)):
        ...
        self.com = interface
        self.com.start()
        self.com.register_msg_callback('set_pose', self.set_pose)
    ...
    def update_odom_report(self, dt):
        ...
        pos.x = odom_report[0]
        pos.y = odom_report[1]
        pos.theta = odom_report[2]
        self.com.send("get_pose", m.Position, pos)
        
    def set_pose(self, topic_name, msg, time):
        self.nav.set_pos_objective((msg.x, msg.y, msg.theta))
...
if __name__ == '__main__':
    ...
    #    exit(-1)
    ecal_interface = EcalInterface("aaaa")
    with Robot(ecal_interface, True) as robot:
        robot.run()
